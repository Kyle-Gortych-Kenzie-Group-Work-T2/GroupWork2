...
<details>
    <summary>Weekly Roster Manager</summary>
...
public class WeeklyRosterManager {
    ...
    public boolean scheduleSwap(SectionDay swapOutOf, long participantId) {
        ...
        if (swapOutOf.equals(SectionDay.TUESDAY) && tuesdayParticipants.contains(participantId) && numTuesSwaps < maxSwapSize) {
            // Add participantId to thursdaySwapIns
            thursdaySwapIns.add(participantId);
            // Add participantId to thursdayParticipants
            thursdayParticipants.add(participantId);
            // Remove participantId from tuesdayParticipants
            tuesdayParticipants.remove(participantId);
            // Increment the count of Tuesday swaps
            numTuesSwaps++;
            swapSuccessful = true;
        } else if (swapOutOf.equals(SectionDay.THURSDAY) && thursdayParticipants.contains(participantId) && numThursSwaps < maxSwapSize) {
            // Add participantId to tuesdaySwapIns
            tuesdaySwapIns.add(participantId);
            // Add participantId to tuesdayParticipants
            tuesdayParticipants.add(participantId);
            // Remove participantId from thursdayParticipants
            thursdayParticipants.remove(participantId);
            // Increment the count of Thursday swaps
            numThursSwaps++;
            swapSuccessful = true;
        }
