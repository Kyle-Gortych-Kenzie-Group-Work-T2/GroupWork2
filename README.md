...
public class WeeklyRosterManager {
    ...
    public void addParticipantsToSection(SectionDay section, String participantList) {
        ...
        // given which day and string participantList
        //  Where do we get their names from?  Maybe there's a map - if you have id, get name
    }
    ...
    public void printSectionRosters() {
        // ATA Participants - implement
        // todo **************************
        // Print out class rosters for both TUESDAY AND THURSDAY
        // will use the iterator() to get ID values
    }
    ...
    public boolean scheduleSwap(SectionDay swapOutOf, long participantId) {
        // ATA Participants - implement
        // todo ********************  # 4
        // take participantID person out of swapOutOf
        // put them in the other day's roster
        // each section (tues or thurs) is only allowed 5 swaps per week
        // once coded, uncomment the tests inside this file
        return false;
    }
